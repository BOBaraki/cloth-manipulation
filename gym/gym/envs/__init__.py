...
for reward_type in ['sparse', 'dense']:
    ...
    # Kinova Gen3 sideways fold Randomized
    register(
        id='RandomizedGen3DiagonalFold{}-v0'.format(suffix),
    ...
    register(
        id='RandomizedGen3LiftTwoHands{}-v0'.format(suffix),
    ...
    register(
        id='RandomizedGen3SidewaysFoldOneHand{}-v0'.format(suffix),
    ...
    register(
        id='RandomizedGen3LiftOneHand{}-v0'.format(suffix),
